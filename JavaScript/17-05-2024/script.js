...
var warningMessage=document.getElementsByClassName("warning-message")[0]
...
function increaseHandler(){
    ...
    if(currentValue === 10){
        ...
        warningMessage.innerText="It can't exceed 10.";
    }else{
        currentValue+=1
...
function decreaseHandler(){
    ...
    if(currentValue === -10){
        overlay.classList.remove("hidden")
        warningMessage.innerText="It can't go beyond -10.";
    }else{
        currentValue-=1
        numberHeading.innerText = currentValue
        console.log(currentValue)
